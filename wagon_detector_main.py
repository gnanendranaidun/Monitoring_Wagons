...
def main():
    parser = argparse.ArgumentParser(description="Wagon Detection from Video")
    parser.add_argument("video_path", help="Path to the input video file")
    parser.add_argument("--output", help="Optional: path to save output video", default=None)
    ...
    try:
        ...
        wagon_count = process_video(args.video_path, args.output, not args.no_display)
